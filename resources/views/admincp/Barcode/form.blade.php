        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    {{-- {!! dd($list[0]->id); !!} --}}
                    @if(!isset($barcode))
                    <div class="form-group col-md-2 text-center" style="align-self: end;"> {!! Form::submit('Lưu',['class'=>'btn btn-success btn-submit']) !!} <input type="submit" class='btn btn-success btn-submit' value="Lưu và in" name="clickinput2">
                    @else
